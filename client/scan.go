// FIXME: this could be useful in other part with the golang
// so I think this could be movend in one of the following repository
//
// - lnmetrics.utils: https://github.com/LNOpenMetrics/lnmetrics.utils
// - cpstl: https://github.com/vincenzopalazzo/cpstl
package client
